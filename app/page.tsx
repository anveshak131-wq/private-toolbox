...
export default function HomePage() {
  return (
    <main className="min-h-screen max-w-6xl mx-auto px-6 py-12 text-slate-100 flex flex-col items-center">
      {/* Hero Section */}
      <section className="text-center space-y-4 max-w-3xl my-10">
        ...
        <p className="text-slate-400 text-sm sm:text-base leading-relaxed">
          Compress, convert, and manage your files directly inside your browser. Your files never leave your device.
        </p>
      </section>
          ...
          >
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-3xl p-3 bg-slate-800/50 rounded-xl border border-slate-700/50">
                  {tool.icon}
                </span>
                <span className="text-[10px] font-bold uppercase tracking-wider px-2.5 py-1 bg-slate-800 text-slate-400 rounded-full border border-slate-700">
                  {tool.badge}
                </span>
              </div>
              <div>
